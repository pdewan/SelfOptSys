...
public class ABasicLazyRespTimeTradeoffPolicy 
	...
	public int compareResponseTimes(
	    ...
	    if ( firstSchedulingPolicy == SchedulingPolicy.MULTI_CORE_LAZY_PROCESS_FIRST &&
	            secondSchedulingPolicy != SchedulingPolicy.MULTI_CORE_LAZY_PROCESS_FIRST ) {
	        return -1000000;
	    }
	    else if ( firstSchedulingPolicy != SchedulingPolicy.MULTI_CORE_LAZY_PROCESS_FIRST &&
	            secondSchedulingPolicy == SchedulingPolicy.MULTI_CORE_LAZY_PROCESS_FIRST ) {
	        return 1000000;
	    }
